...
const row = (over: Partial<CraftFlipRow>): CraftFlipRow => ({
  ...
  velocity: 2, gilPerDay: 1800, hq: true,
  ...
  sourcing: null, selfSourceGilPerDay: 1800, ...over,
});
...
describe('CraftFlipResults — sourcing UI', () => {
  it('shows the GATHERABLE tag when gatherablePct >= 80', () => {
    ...
    render(wrap(<CraftFlipResults rows={rows} totalCandidates={1} skippedChunks={0} scope="home" />));
