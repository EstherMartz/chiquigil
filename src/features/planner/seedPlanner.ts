...
function mk(name: string, src: string, price: number, perDay: number, supply: number | null): PlanItem {
  return { id: newItemId(), name, src, price, perDay, supply, active: true, earned: 0, units: 0 };
}
...
export function seedPlanner() {
  return {
    ...
    lanes: {
      craft: [
        mk('Plain Hooded Tunic', 'Weaver', 4_025_000, 1.1, 0.9),
        mk('Crested Shirt of Crafting', 'iL750 gear', 399_500, 1.7, 1.8),
        mk("Courtly Lover's Partisan", 'weapon craft', 437_961, 1.6, 1.9),
        mk("Courtly Lover's Cane", 'weapon craft', 579_896, 1.0, 1.0),
        mk('Grade 4 Gemdraughts (filler)', 'Alchemist · vol', 4_150, 250, 2.0),
      ],
      gather: [
        mk('Yollal Extract', 'gatherable', 7_900, 154, null),
        mk('Everkeep Resin', 'gatherable', 7_999, 108, null),
        mk('Levinchrome Aethersand', 'Cosmic Auxesia', 1_800, 266, null),
        mk('Double Duracoat', 'gatherable', 7_499, 69, null),
      ],
      content: [
        mk('Occult Bracelet of Blood', 'Occult Crescent', 40_000_000, 0.3, null),
        mk('Occult Necklace of Blood', 'Occult Crescent', 43_249_499, 0.1, null),
        mk('Cosmoboard', 'Cosmic Exploration', 2_964_474, 0.3, null),
      ],
      passive: [
        mk("Craftsman's Command Materia XII", 'spiritbond', 14_392, 20, null),
        mk("Gatherer's Guile Materia XII", 'spiritbond', 6_352, 34, null),
        mk('Timeworn Gargantuaskin Map', 'gather + sell', 41_499, 2.9, null),
      ],
    },
