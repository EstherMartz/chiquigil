...
// src/bot/linkifyItems.ts
var ITEMS_BASE_URL = (typeof process !== "undefined" ? process.env.PROJECTS_BASE_URL : void 0) ?? "https://qiqirn.tools";
var BOLD = /\*\*([^*\n]+)\*\*/g;
function linkifyItems(text, nameIndex) {
  if (!text) return text;
  return text.replace(BOLD, (match, inner, offset) => {
...
var ITEMS_BASE_URL2 = (typeof process !== "undefined" ? process.env.PROJECTS_BASE_URL : void 0) ?? "https://qiqirn.tools";
var JOB_EMOJI = {
  CRP: "\u{1FA9A}",
  BSM: "\u2692\uFE0F",
  ARM: "\u{1F6E1}\uFE0F",
...
function taskLine(t) {
  ...
  const itemLink = `[**${t.itemName}**](${ITEMS_BASE_URL2}/item/${t.itemId})`;
