...
export const PRESETS: QueryPreset[] = [
  {
    ...
    filter: { searchCategories: [], hq: 'hq', minDealPct: 30, minVelocity: 0,
              ...
              scope: 'dc', maxListings: null, mode: 'standard', minGap: null, trainedEye: false },
  },
  {
  ...
  },
  {
    ...
    filter: { searchCategories: [], hq: 'either', minDealPct: 30, minVelocity: 1,
              minPrice: null, maxPrice: null, sort: 'gilFlow', limit: 100,
              scope: 'home', maxListings: null, mode: 'repost', minGap: 10_000, trainedEye: false },
  },
  {
    id: 'out-of-stock', label: 'Out of Stock', category: 'trading',
    desc: 'Items selling on Phantom with zero current listings. No competition — list at your price. Velocity ≥ 0.14/day (~1 sale per week).',
    filter: { searchCategories: [], hq: 'either', minDealPct: 0, minVelocity: 0.14,
              minPrice: null, maxPrice: null, sort: 'gilFlow', limit: 100,
              scope: 'home', maxListings: 0, mode: 'standard', minGap: null, trainedEye: false },
  },
  {
    id: 'out-of-stock-nq', label: 'Out of Stock NQ', category: 'trading',
    desc: 'Same as Out of Stock but NQ-only — useful for furniture, dyes, and gathered items that do not need a craft rotation.',
    filter: { searchCategories: [], hq: 'nq', minDealPct: 0, minVelocity: 0.14,
              minPrice: null, maxPrice: null, sort: 'gilFlow', limit: 100,
              scope: 'home', maxListings: 0, mode: 'standard', minGap: null, trainedEye: false },
  },
  {
  ...
  },
  {
    ...
    filter: { searchCategories: [44, 46, 47, 48, 49, 50, 53, 58, 81], hq: 'nq',
              ...
              mode: 'standard', minGap: null, trainedEye: false },
  },
  {
  ...
  },
  {
    ...
    desc: 'HQ meals ranked by gil/day on the DC. Mirrors the Watchlist Food category.',
    filter: { searchCategories: [45], hq: 'hq', minDealPct: 0, minVelocity: 1,
              minPrice: null, maxPrice: null, sort: 'gilFlow', limit: 100,
              scope: 'dc', maxListings: null, mode: 'standard', minGap: null, trainedEye: false },
  },
  {
    id: 'top-fish', label: 'Top fish', category: 'trading',
    desc: 'Seafood ranked by gil/day on the DC. Mirrors the Watchlist Fish category.',
    filter: { searchCategories: [46], hq: 'either', minDealPct: 0, minVelocity: 0.5,
              minPrice: null, maxPrice: null, sort: 'gilFlow', limit: 100,
              scope: 'dc', maxListings: null, mode: 'standard', minGap: null, trainedEye: false },
  },
  {
    id: 'top-tinctures', label: 'Top tinctures', category: 'trading',
    desc: 'HQ medicine ranked by gil/day on the DC. Mirrors the Watchlist Tincture category.',
    filter: { searchCategories: [43], hq: 'hq', minDealPct: 0, minVelocity: 1,
              minPrice: null, maxPrice: null, sort: 'gilFlow', limit: 100,
              scope: 'dc', maxListings: null, mode: 'standard', minGap: null, trainedEye: false },
  },
  {
    id: 'top-dyes', label: 'Top dyes', category: 'trading',
    desc: 'NQ dyes ranked by gil/day on the DC. Mirrors the Watchlist Dye category.',
    filter: { searchCategories: [54], hq: 'nq', minDealPct: 0, minVelocity: 0.5,
              minPrice: null, maxPrice: null, sort: 'gilFlow', limit: 100,
              scope: 'dc', maxListings: null, mode: 'standard', minGap: null, trainedEye: false },
  },
  {
    id: 'top-materia', label: 'Top materia', category: 'trading',
    desc: 'Materia ranked by gil/day on the DC. Mirrors the Watchlist Materia category.',
    filter: { searchCategories: [57], hq: 'either', minDealPct: 0, minVelocity: 1,
              minPrice: null, maxPrice: null, sort: 'gilFlow', limit: 100,
              scope: 'dc', maxListings: null, mode: 'standard', minGap: null, trainedEye: false },
  },
  {
    id: 'top-minions', label: 'Top minions', category: 'trading',
    desc: 'All minions ranked by gil/day on the DC, no price cap. Mirrors the Watchlist Minion category.',
    filter: { searchCategories: [75], hq: 'either', minDealPct: 0, minVelocity: 0.5,
              minPrice: null, maxPrice: null, sort: 'gilFlow', limit: 100,
              scope: 'dc', maxListings: null, mode: 'standard', minGap: null, trainedEye: false },
  },
  {
